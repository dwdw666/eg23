...
public class gestion_du_semestre_en_cours {
	...
	private void initialize() {
		...
		JLabel row1_label1 = new JLabel("Des \u00E9tudiants avec leur retard");
		...
		row1_button.setBounds(200, 50, 80, 150);
		...
		JLabel row2_label1 = new JLabel("Des \u00E9tudiants dont le retard est critique");
		...
		row2_button.setBounds(200, 200, 80, 150);
		...
		JLabel row3_label1 = new JLabel("Des \u00E9tudiants candidats \u00E0 l\u2019excellence");
		...
		row3_button.setBounds(200, 350, 80, 150);
